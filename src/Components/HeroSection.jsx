        ...
        <div id='home' className='hidden md:flex min-h-[530px] gap-12 max-w-[1280px] mt-10 mb-8 mx-auto px-20 justify-between items-center'>
            <div className='flex flex-row w-[57%] gap-20 items-center'>
                <div className='flex flex-col gap-7 justify-center'>
                    <Link to={'https://www.linkedin.com/in/sowmya-yalavarthi/'} target='_blank'>
                        <FiLinkedin className='text-blue-700 hover:drop-shadow-md' size={30}/>
                    </Link>
                    <Link to={'mailto:sowmyayalavarthi98@gmail.com'} target='_blank'>
                ...
                <div className='flex flex-col gap-7 w-full'>
                    <p className='text-5xl font-poppins md:font-[800] lg:font-[900] text-blue-700'><span className='font-semibold text-black'>I'm, </span>Sowmya Yalavarthi</p>
                    <TypeAnimation
                        sequence={[
                            'Data Scientist', 2000,
                            'Machine Learning Engineer', 2000,
                            'Data Engineer | Cloud & ETL Pipelines', 2000,
                            'AI & Generative AI Enthusiast', 1000,
                            /*'MERN Developer', 1000,*/
                            'Problem Solver', 1000,
                            'Coder', 1000
                        ]}
            ...
            <div className=''>
                ...
                <img src={SowmyaImg} className='z-50 contrast-125 scale-95 transition-all duration-1000 max-h-[430px]'/>
        ...
        <div id='home' className='flex flex-col md:hidden max-w-[1280px] mt-10 mb-8 mx-auto justify-between'>
            <div className='flex flex-row w-full px-10 mx-auto items-center justify-around'>
                ...
                <div className='flex mt-9 flex-col pl-10 gap-4 w-full'>
                    ...
                    <p className='text-base text-justify'>A Data Scientist and Data Engineer with 4+ years of experience, blending strong software engineering with advanced analytics. I love transforming complex data problems into scalable, intelligent solutions and believe AI is as much about people as it is about technology. Curiosity isn’t just a skill for me—it’s a lifestyle.</p>
                    <div className='flex gap-4'>
            ...
            <div className='flex items-center justify-center'>
                {/* <img src={Blob} className='absolute z-50 h-[500px] -translate-x-5 translate-y-10 scale-150 opacity-80'/> */}
                <img src={SowmyaImg} className='z-10 mb-10 flex md:hidden contrast-125 scale-95 transition-all duration-1000 h-[350px]'/>
            </div>
    </>
  )
}
